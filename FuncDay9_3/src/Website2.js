...
<div class="text-center h1">Our Tours</div>
    ...
    {datas.map((data, i) => <div key={i}><div class='image'><img src={data.image} />
        <br />
        <div class='display'>
        ...
        <div class="text text-center"><button type="button" class="button btn btn-outline-danger" onClick={() =>handleDelete(i)}>Not Interested</button></div>
