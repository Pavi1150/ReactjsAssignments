...
import './website2.css'
export class Website2 extends Component {
    state = {
        read: false,
    ...
    handleRead = (e) => { this.setState({ read: true }) }
    handleToggle = (e) => { this.setState({ read: !this.state.read }) }
        ...
        return (
            <div class='tour'>
                ...
                <div class="text-center h1">Our Tours</div>
                    ...
                    {this.state.datas.map((data, index) => <div key={data.id}><div class='image'><img src={data.image} />
                        <br />
                        <div class='display'>
                        ...
                        <br />
                        <div>
                            <p class="read">{this.state.read ? data.info : data.info.slice(0, 200)}
                                <a href="#"class="color" onClick={this.handleToggle}>{this.state.read ? 'Show Less' : 'Read More'}</a>
                            </p>
                            

                        </div>
                        <div class="text text-center"><button type="button" class="button btn btn-outline-danger" onClick={() => this.handleDelete(index)}>Not Interested</button></div>
